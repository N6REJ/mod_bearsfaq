...
- **Dual Display Modes**: Choose between tabs or pills for navigation
...
- **Tab Styles**: Choose between traditional tabs or modern pills
- **Color Customization**: Configure colors for active/inactive tabs, borders, and text
- **Layout Options**: Multiple tab alignment options (left, center, right, justified, etc.)
...
2. **Configure Settings**:
   ...
   - Choose tab style and orientation
